...
const allDisasters = ref([
  { rank: 1, name: '小满寒', type: '气象灾害', probability: '中等' },
  { rank: 2, name: '冷害', type: '气象灾害', probability: '低' },
  { rank: 3, name: '高温热害', type: '气象灾害', probability: '非常低' },
  { rank: 4, name: '高温', type: '气象灾害', probability: '非常低' },
  { rank: 5, name: '湿渍害', type: '气象灾害', probability: '非常低' },
  { rank: 6, name: '涝害', type: '气象灾害', probability: '非常低' },
  { rank: 7, name: '大风', type: '气象灾害', probability: '非常低' },
  { rank: 8, name: '冰雹', type: '气象灾害', probability: '非常低' },
  { rank: 9, name: '冻害', type: '气象灾害', probability: '--' },
  { rank: 10, name: '霜冻', type: '气象灾害', probability: '--' },
  { rank: 11, name: '干旱', type: '气象灾害', probability: '低' },
  { rank: 12, name: '连阴雨', type: '气象灾害', probability: '中等' },
  { rank: 13, name: '病虫害', type: '生物灾害', probability: '高' },
  { rank: 14, name: '草害', type: '生物灾害', probability: '非常低' },
  { rank: 15, name: '鸟害', type: '生物灾害', probability: '--' },
]);
